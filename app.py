...
st.markdown(f"""
    <style>
    /* 1. إصلاح التوسيط الإجباري (للتغلب على الـ RTL) والخلفية الزجاجية */
    .hero-container {{
    ...
    /* 5. 🌟 منطقة رفع الملفات الزجاجية والملونة (الـ Upload) 🌟 */
    [data-testid="stFileUploadDropzone"] {{
        background: rgba(255, 255, 255, 0.03) !important;
        backdrop-filter: blur(15px) !important;
    ...
    [data-testid="stFileUploadDropzone"]:hover {{
        ...
        box-shadow: 0 15px 40px rgba(212, 175, 55, 0.2), inset 0 0 30px rgba(212, 175, 55, 0.1) !important;
        transform: translateY(-5px) scale(1.01) !important;
    }}

    /* 6. 🌟 زر Browse files (الملون والمتحرك) 🌟 */
    [data-testid="stFileUploadDropzone"] button {{
        background: linear-gradient(45deg, #d4af37, #f9f295, #d4af37) !important;
    ...
    <div class="hero-container">
        ...
        <h1 class="hero-title">SmartStat Pro</h1>
