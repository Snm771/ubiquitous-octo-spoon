...
# ==========================================
# سحب مفتاح الذكاء الاصطناعي تلقائياً (الإضافة الجديدة)
# ==========================================
    ...
    try:
        ...
        if not analysis_cols:
            ...
            with tab7:
                ...
                if not api_key:
                    st.error("⚠️ يرجى إدخال مفتاح OpenAI API في القائمة الجانبية أو إضافته في إعدادات التطبيق لتفعيل هذه الميزة الحصرية.")
                else:
