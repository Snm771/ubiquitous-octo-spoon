        ...
        if not analysis_cols:
            ...
            with tab1:
                ...
                if categorical_cols:
                    ...
                    st.info(f"يوضح العرض الإحصائي (الجدول والشكل البياني) أعلاه التوزيع التكراري والنسبي لأفراد عينة الدراسة وفقاً لتصنيفاتهم في متغير ({demo_col}). ويُعد هذا التوصيف الديموغرافي محطة منهجية حيوية في مسار البحث العلمي، حيث يهدف إلى إبراز مدى تنوع وتمثيل العينة لشرائح مجتمع الدراسة الأصلي. إن القراءة التحليلية لهذه النسب لا تقتصر على السرد الرقمي فحسب، بل تمتد لفهم الخلفيات المتنوعة التي تنطلق منها استجابات المبحوثين. فالتجانس أو التباين الظاهر في فئات هذا المتغير يسهم بشكل مباشر في إثراء نتائج الدراسة، ويعزز من الموثوقية الخارجية (External Validity) للأداة، مما يمنح الباحث مساحة أوسع وأكثر دقة وموضوعية في تعميم النتائج وتفسير الفروق الإحصائية اللاحقة.")
